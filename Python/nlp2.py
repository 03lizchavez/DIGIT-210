...
words_chosen = {'love': 1, 'feelings': 2, 'heart': 3}
sorted_words_by_chosen = sorted(words_chosen.items(), key=lambda x: x[1])
print(sorted_words_by_chosen)

converted_dict = dict(sorted_words_by_chosen)
